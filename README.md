...
## Sitemap
#### Registration
![registration page](example_img/registration.png)
...
#### Parking Submission
![submission page](example_img/submission.png)
...
#### Search
![search page](example_img/search.png)
...
![results page pt1](example_img/results-1.png) ![results page pt2](example_img/results-2.png)
...
![reservation page pt1](example_img/reserve-1.png) ![reservation page pt2](example_img/reserve-2.png)
...
| passwordhash  | TEXT NOT NULL  | <br />
| profileurl  | TEXT DEFAULT NULL  | <br />
| pid  | INT(11) UNSIGNED NOT NULL  | <br />
|**CONSTRAINT FOREIGN KEY** (pid) **REFERENCES** parkings(id) **ON DELETE CASCADE** | <br />
| rid  | INT(11) UNSIGNED NOT NULL  | <br />
|**CONSTRAINT FOREIGN KEY** (rid) **REFERENCES** reviews(id) **ON DELETE CASCADE** | <br />
| **CONSTRAINT** pk_users **PRIMARY KEY** (id) | <br />
...
| weeklyprice  | DECIMAL(5,2) NOT NULL  | <br />
| latitude  | DECIMAL(10,6) NOT NULL  | <br />
| longitude  | DECIMAL(10,6) NOT NULL  | <br />
| imageurl  | TEXT NOT NULL | <br />
| videourl  | TEXT DEFAULT NULL | <br />
| **CONSTRAINT** pk_parkings **PRIMARY KEY** (id) | <br />

##### Reviews Table 
| Field  | Data Type | <br />
| ------------- | ------------- | <br />
| id  | INT(11) UNSIGNED NOT NULL AUTO_INCREMENT | <br />
| rating  | INT(1) NOT NULL  | <br />
| review  | TEXT NOT NULL  | <br />
| **CONSTRAINT** pk_reviews **PRIMARY KEY** (id) | <br />
